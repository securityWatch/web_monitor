    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <form onSubmit={submit} className="card space-y-4">
        ...
        <div>
          ...
          <select className="input" value={form.type} onChange={(e) => setForm({ ...form, type: e.t            <option value="ping">{t('typePing')}</option>
            <option value="api_json">{t('typeApiJson')}</option>
            <option value="keyword">{t('typeKeyword')}</option>)}</option>
