...
| ID | 任务 | 优先级 | 状态 |
|----|------|:------:|------|
| P5-1 | 真分布式探针 Worker | P0 | 🔶 代码有；生产需 `PROBE_DISPATCH` + 部署 |
| P5-2 | 移动端底栏 | P0 | ✅ |
| P5-3 | 国内 IM 生产验证 | P0 | 🔶 |
| P5-4 | On-Call 升级 + 事件指挥台 | P1 | ✅ |
| P5-5 | 故障截图 + 取证 Tab | P1 | 🔶 占位图 MVP |
| P5-6 | 状态页公告 + uptime 历史 | P1 | ✅ |
| P5-7 | Twilio 语音 | P1 | 🔶 需 env + Business |
| P5-8 | 列表虚拟滚动 + 批量 | P1 | 🔶 手写虚拟化 + 批量 ✅ |
| P5-9 | 套餐配额门控 | P1 | ✅ |
| P5-10 | Terraform Provider v0.1 | P1 | 🔶 示例/client |
| P5-11 | Core Web Vitals | P2 | 🔶 估算 |
| P5-12 | ⌘K 命令面板 | P2 | ✅ |
| P5-13 | SSO OIDC | P2 | 🔶 配置 API |
| P5-14 | Opsgenie | P2 | ✅ |
| P5-15 | 竞品对比落地页 | P1 | ✅ |
